<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="enrollment-assistance.aspx.cs" Inherits="Insurance_Enrollment_2024.enrollment_assistance" %>
            ...
            <div class="row gx-5">
			   ...
			   <div class="col-lg-8">
                    <div class="mb-4">
                        ...
                        <h1 runat="server" id="h1Header2" class="display-6">I have NOT enrolled in a Marketplace/ACA Plan for 2024</h1>
                    </div>
                    <div runat="server" visible="false" style="background-color: #fcd7e3; color:#000; font-size:120%; border-radius: 10px; padding:10px 20px; margin-bottom:10px">
                        ...
                        <span class="iconscontainer">
                            ...
                            <span class="spanToolTip spanToolTipWidth">
                   ...
                   <div runat="server" visible="true" style="background-color: #fcd7e3; color:#000; font-size:100%; border-radius: 10px; padding:10px 20px; margin-bottom:15px">
                       <b>Special Enrollment Period:</b> Outside the yearly Open Enrollment Period you can sign up for health insurance if you qualify. You qualify for a Special Enrollment Period if you’ve had certain life events, including losing health coverage, moving, getting married, having a baby, or adopting a child, or if your household income is below a certain amount.
                   </div>
