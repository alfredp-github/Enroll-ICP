<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default-2025-2.aspx.cs" Inherits="Insurance_Enrollment_2024.default_2025_2" %>
...
<a>** Important Changes for 2024 ** Before completing the form, please <u>read</u> before enrolling.</a>
    ...
    <div class="container-fluid bg-primary py-5 mb-5 nex-mb-5 hero-header" style="borderX:red 1px solid; padding-bottom:0px !important; padding-left:0px; padding-right:0px">
        <div class="container py-5X"  style="borderX:green 1px solid; padding-bottom:0px !important; padding-top:30px; padding-bottom:40px !important; max-width:1450px !important">
            <div class="row justify-content-start" style="borderX:red 1px solid; padding-bottom:0px !important">
                <div class="col-lg-10 text-center text-lg-start " style="width:100%">
                    <div style="floatX:left">
					    ...
					    <h5 class="d-inline-block text-primaryXX nex-text-primary text-uppercase border-bottom border-2" style="border-color: rgba(256, 256, 256, .3) !important; font-size:1.8em">Welcome To The Insurance Premium Assistance Program</h5>					
                    ...
                    <div class="pt-2 nex-left-side" style="float:left; margin-bottom:15px; margin-right:13px">
                        <div class="back-rgba-opacity-3" style="displayX:flex; background-color:#fff; border-radius:10px; padding:20px 30px; font-sizeX:1.4em; background: rgba(255, 255, 255, .60); backgroundX: rgba(250, 270, 70, .60); ">
                            <h4 class="mb-3" style="margin-bottom:0px !important; padding-bottom:0px">Have you recently renewed your <span style="color:#f26202">Program Eligibility?</span> Verify your coverage now <span style="opacity:0.3">&#10095;&#10095;</span></h4>
                            <div style="font-sizeX:60%; margin-top:0px; padding-top:0px; color:black">
                                When you renew your progran eligibility you need to confirm that you want to continue with premium assistance.
                            </div>
...
<div class="tabs">
    ...
    <label class="label" for="tabone">Insurance for <span style="color:orangered">2025</span></label>
    <div class="panel" tabindex="1">

        <div class="pt-2 nex-left-side" style="float:left; padding-top:0px !important; margin-bottomX:15px; margin-rightX:13px; ">
            <div class="back-rgba-opacity-3" style="displayX:flex; background-color:#fff; border-radius:10px; padding:20px 30px; border:lightgray 1px solid; font-sizeX:1.4em; background: rgba(255, 255, 255, .60); backgroundX: rgba(250, 270, 70, .60); ">
                <h4 class="mb-3" style="margin-bottom:0px !important; padding-bottom:0px">I want to <span style="color:#1786c2">PRE-REGISTER</span> for a 2025 Marketplace / ACA Plan <span style="opacity:0.3">&#10095;&#10095;</span></h4>
                <div style="font-sizeX:60%; margin-top:0px; padding-top:0px; color:black">
    ...
    <div class="panel" tabindex="1">
				    ...
				    <div class="row g-0 g-9">
                        <a runat="server" id="aExistingPolicy_ACA1" class="nex-bigicon-link" target="_self" style="">
					        <div class="col-lg-3 col-md-6" style="width:22em !important">
						        <div class="service-item bg-lightX rounded d-flex flex-column align-items-center justify-content-center text-center" style="margin-right:10px; background-color:#fff; border-top:#1786c2 4px solid; border-radius:10px; padding:20px 30px; font-sizeX:1.4em; background: rgba(255, 255, 255, .60);">
							        <div runat="server" visible="false" class="service-icon mb-4" style="height:40px; width:40px">
								        <i class="fa fa-2x icon-insurance text-white" style="background-size:20px 20px"></i>
							        </div>
							        <h4 class="mb-3" style="font-size:1.4rem; color:#0c557d; margin-bottom:10px !important">Special Enrollment: <span style="color:#1786c2">Get an Insurance Policy for 2024</span> <span style="opacity:0.3">&#10095;&#10095;</span></h4>
							        <p class="m-0" style="displayX:none; color:#3d3d3d; line-height:135%">Enroll in a new insurance policy in the Marketplace / ACA (Health Insurance Marketplace)</p>
                        ...
                        <a runat="server" id="aExistingPolicy_Employer1" class="nex-bigicon-link" target="_self">
					        <div class="col-lg-3 col-md-6" style="width:22em !important">
						        <div class="service-item bg-lightX rounded d-flex flex-column align-items-center justify-content-center text-center" style="margin-right:10px; background-color:#fff; border-top:#3b731a 4px solid; border-radius:10px; padding:20px 30px; font-sizeX:1.4em; background: rgba(255, 255, 255, .60);">
							        <div runat="server" visible="false" class="service-icon mb-4">
								        <i class="fa fa-2x icon-insurance-employer text-white"></i>
							        </div>
							        <h4 class="mb-3" style="font-size:1.4rem; color:#3b731a; margin-bottom:10px !important">Enroll your existing insurance policy for 2024 <span style="opacity:0.3">&#10095;&#10095;</span></h4>
                                    <p class="m-0" style="displayX:none; color:#3d3d3d; line-height:135%">You have a health insurance policy (ACA/Employer/COBRA) that you have not yet enrolled here.</p>
                        ...
                        <a runat="server" id="a3" class="nex-bigicon-link" target="_self" >
					        <div class="col-lg-3 col-md-6" style="width:16em !important">
						        <div class="service-item bg-lightX rounded d-flex flex-column align-items-center justify-content-center text-center" style="background-color:#fff; border-top:#3d3d3d 4px solid; border-radius:10px; padding:20px 30px; font-sizeX:1.4em; background: rgba(255, 255, 255, .60);">
							        <div runat="server" visible="false" class="service-icon mb-4">
								        <i class="fa fa-2x icon-insurance-employer text-white"></i>
							        </div>
							        <h4 class="mb-3" style="font-size:1.4rem; color:#cc4400; margin-bottom:10px !important">Miami-Dade<br />Assessment <span style="opacity:0.3">&#10095;&#10095;</span></h4>
                                    <p class="m-0" style="displayX:none; color:#3d3d3d; line-height:135%">There is a different<br />enrollment process<br />for Miami-Dade residents.</p>
							        <p class="m-0" style="display:none">Ensure that you have your employer complete the attached letter to accept premium payments (third party letter on website)</p>
							        <a runat="server" id="a4" class="btn btn-lg btn-primary rounded-pill">
								        <i class="bi bi-arrow-right"></i>
							        </a>
						        </div>
					        </div>	
        ...
        <div class="container">
            <div class="row gx-5">
                ...
                <div class="col-lg-7">
                    ...
                    <p>
                        <div style="margin-bottom:15px; font-size:120%; line-height:120% !important; color:orangered">For Agents, Brokers, Navigators, Certified Application Counselors, Assisters and Case Managers you can <b><a href="register.aspx" style="text-decoration:underline">Register Now</a></b> for resource access.</div>
