<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="existing-policy-ins.aspx.cs" Inherits="Insurance_Enrollment_2024.existing_policy_ins" %>
            ...
            <div classX="row gx-5">
			   ...
			   <div class="col-lg-10">
                    <div class="mb-4">
                        ...
                        <h1 runat="server" id="h1Header2" class="display-6">I have Already enrolled in an Insurance Plan for 2024</h1>
                    </div>
                    <div>
                        ...
                        <ul style="float:left; margin-bottom: 0px; margin-right:70px">
							...
							<li>
				   			<a runat="server" id="aNeedPolicy" style="font-weight:bold">*If you do not have any of these, then <u>Get Assitance with Enrollment</u>.</a>	
							</li>
                        </ul>	
						<a style="display:none; float:left; font-size:90%" href="enrollment-assistance-cy.aspx">*<i>If you do not have any of these,<br />then <u>Get Assitance with Enrollment</u></i>.</a>	
                        <div style="clear:both"></div>					
					</div>

					<div style="display:none; margin-top:10px; margin-bottom:5px">
						<a style="font-weight:bold" href="enrollment-assistance-cy.aspx">*If you do not have any of these, then <u>Get Assitance with Enrollment</u>.</a>	
					</div>
				...
				<div class="row g-0 g-9" style="margin-top:10px">
                    ...
                    <a runat="server" id="aExistingPolicy_Agent1" visible="false" class="nex-bigicon-link" target="_self">
					<div class="col-lg-3 col-md-6">
						<div class="service-item bg-lightX rounded d-flex flex-column align-items-center justify-content-center text-center">
							<div class="service-icon mb-4">
