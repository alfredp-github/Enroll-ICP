<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default_test.aspx.cs" Inherits="Insurance_Enrollment_2024.default_test" %>
    ...
    <style type="text/css">
        ...
        @media (max-width: 767.98px) {
            ...
            .nex-recertify {
                ...
                borderX:orange 5px dashed !important;
                margin-bottom:12px;
            ...
            .nex-left-side {
                ...
                borderX:green 5px solid !important;
                width:100% !important;
            ...
            .nex-left-side div {
                ...
                borderX:red 1px solid !important;
                width:100% !important;
                align-items: center;
        ...
        @media (min-width: 767.99px) and (max-width: 991.98px) {
            ...
            .miamidade2 
            {
                ...
                font-size:1.45em !important;
                                               ...
                                               /* background-color:#096631 !important;*/
                                               background-color:#fffdab !important;
...
/*        @media (min-width: 1099.99px) and (max-width: 1150px) {*/
       ...
       @media (min-width: 1079px) and (max-width: 1081px) {
        ...
        @media (min-width: 991.99px) and (max-width: 1079px) {
...
<a>** Important Changes for 2024 ** Before completing the form, please <u>read</u> before enrolling.</a>
    ...
    <div class="container-fluid bg-primary py-5 mb-5 nex-mb-5 hero-header" style="borderX:red 1px solid; padding-bottom:0px !important; padding-left:0px; padding-right:0px">
        <div class="container py-5"  style="borderX:purple 1px solid; padding-bottom:40px !important">
            <div class="row justify-content-start" style="borderX:red 1px solid; padding-bottom:0px !important">
                <div class="col-lg-9 text-center text-lg-start" style="width:100%;borderX:yellow 1px solid; padding:0px">
                    <div style="floatX:left;borderX:green 1px solid">
					    ...
					    <h5 class="d-inline-block text-primaryXX display-0 nex-text-primary text-uppercase border-bottom border-2" style="border-color: rgba(256, 256, 256, .3) !important; font-size:1.8em">Welcome To The Premium Plus Insurance Program</h5>					
                        ...
                        <div class="pt-2 nex-left-left-side" style="float:left; margin-right:19px">
                            <div runat="server" visible="true" class="back-rgba-opacity-2x iconscontainer display-2X nex-recertify" style="font-size:1.1em; font-weight:bold; line-height:115%; color:#757575; border-topX:yellow 5px solid; border-right:#737373 1px solid; border-bottom:#737373 1px solid; border-radiusX:20px 0px 20px 0px; border-radius:1rem; margin-top:0px; padding:16px 22px 16px 22px; background: rgba(255,255,255, .20) url(img/md-logo-2X.png) no-repeat right bottom; background-size:50px 25px; background-imageX:url(img/md-logo.png) no-repeat right bottom;  width:10.40em; text-align:left">
                                
                                <a runat="server" id="aRecertified" href="enrollment-verification.aspx" style="floatX:left; widthX:100%; borderX:pink 3px solid; color:#000; text-shadowX: 0px 0px 6px white; -webkit-text-strokeX: 1px white; text-decorationX:underline">
                                    <span style="color:#185278; text-shadowX: 2px 2px 0px #12566b !important; text-decorationX:underline; text-transformX: uppercase; font-weight:normal; ">Have you recently recertified or renewed your</span>
                                    <span class="nex-block-inline-2X" style="display:block;font-size:1.2em; color:#185278; text-transform: uppercase; line-height:110%; margin-top:3px; letter-spacingX:0.05em ">Program Eligibility?</span>
                                </a>
                                <div style="clear:both"></div>
                                <span class="spanToolTip spanToolTipWidthX" style="line-height:125%">Verify your coverage for 2024. <b style="color:orangered">(click to proceed)</b></span>
                        ...
                        <div class="pt-2 nex-left-side" style="float:left; margin-right:13px">
                            <div style="display:flex; ">
                                ...
                                <a runat="server" id="aEnrollmentAssistanceCY" class="btn btn-lightXX nex-btn-light nex-btn-light-left rounded-pill py-md-3 px-md-5 mx-2" style="font-size:113%; background-color: #ff4d0d; border-color: #ff4d0d; color:#fff;  width:32.6em; flex-shrink: 1; margin-bottom:20px; margin-left:0px !important">SPECIAL ENROLLMENT: I need an Insurance Policy for 2024</a>
                            ...
                            <a runat="server" id="aExistingPolicy"           class="btn btn-lightXX nex-btn-light nex-btn-light-left rounded-pill py-md-3 px-md-5 mx-2" style="font-size:113%; margin-left:0px !important;width:32.6em; flex-shrink: 1; ">I already have Insurance for 2024 (ACA/Employer/COBRA)</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 media-col-lg-9 nex-text-primary" style="display:none; margin-top:40px; font-size:1.2em; font-weight:bold; color:#000">
                    ...
                    <div runat="server" visible="false" class="back-rgba-opacity" style="font-size:1.5em; font-weight:bold; color:#fff; borderX:red 1px solid; border-radius:0px; margin-top:40px; padding:16px 20px; background: rgba(0, 0, 0, .15); width: 100%; text-align:center">
                         <span runat="server" visible="false" style="right:5px; color:#fff; font-size:1.2em">&#187;</span>
                        <a href="enrollment-verification.aspx" style="color:#fff; text-decorationX:underline">Have you recently renewed your program eligibility? Verify your coverage for 2024</a>
                    </div>
    </div>
    <!-- Hero End -->
<div style="padding:10px 40px; text-align:center; background-color:#eb576f; color:#fff;">
