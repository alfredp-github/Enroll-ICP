<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Insurance_Enrollment_2024._default" %>
...
<div runat="server" visible="false" style="width:100%; margin-left:auto; margin-right:auto; background-color:orangered; color:#fff; padding:20px; font-size:1.7em; position: center; text-align:center; z-index:9999999999">
   <b>Attention:</b> The Insurance Premium Assitance Program <b>Website</b> will be down for Scheduled Maintenance:<br />Friday February 14, 2025 5 PM EST through Saturday February 15, 2025 5 PM EST
</div>
<div runat="server" visible="false" style="width:100%; margin-left:auto; margin-right:auto; background-color:orangered; color:#fff; padding:20px; font-size:1.6em; position: center; text-align:center; z-index:9999999999">
   The Insurance Premium Assitance Program <b>Website</b> will undergo <b>scheduled maintenance</b><br /><b>Friday April 18, 2025 5:30 PM EST through Sunday April 21, 2025 7 AM EST</b><br />
    During this period, you may experience temporary disruptions.<br />Thank you for your patience as we work to improve our services.
</div>
                ...
                <div class="col-lg-10 nex-text-center text-lg-start " style="width:100%">
                    ...
                    <div class="pt-2 nex-left-side" style="float:left; margin-bottom:5px; margin-right:0px; width:54em">
                        <div class="back-rgba-opacity-3xx" style="displayX:flex; background-color:#fff; border-radius:10px; padding:17px 30px 15px 25px; font-sizeX:1.4em; background: rgba(255, 255, 255, .80); backgroundX: rgba(250, 270, 70, .60);  ">
                            ...
                            <h4 class="mb-3" style="margin-bottom:0px !important; padding-bottom:0px; margin-top:7px">
